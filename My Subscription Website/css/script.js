const swiper = new Swiper('.swiper', {
    loop: false, // Disabled loop as it can break with a small number of slides
    slidesPerView: 1,
    spaceBetween: 30,
    autoplay: {
        delay: 2500,
    ...
    const getBotResponse = (userInput) => {
        ...
        if (text.includes('buy') || text.includes('purchase') || text.includes('order') || text.includes('get')) {
            if (identifiedProduct) {
                return { text: `Great! I'll open the checkout for ${dealData[identifiedProduct].title}.`, action: { type: 'openModal', payload: identifiedProduct } };
            }
        ...
        if (identifiedProduct) {
            ...
            return { text: `${deal.description} The price is ${deal.price}/month. Would you like to buy it?` };
        }
        ...
        // --- Default Response ---
        return { text: "I'm not sure how to answer that. I can help with questions about our deals (Netflix, Spotify, etc.), pricing, and how to contact us." };
    };
